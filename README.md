...
Notre étude c'est basé sur des données de température acquisent par des stations météo de particuliers. Afin de les analysés, nous avons acquis différentes données d'entrée libre comme notamment les données d'Apur, de l'IAU et de SENTINEL-2. Nous avons extrait de ces données de différentes sources, des facteurs qui joue sur les variations de températures et l'effet de l'ICU. En effet les surfaces de bâti ou végétation joue un rôle important. 

Grâce à nos données nous avons pu avoir une visualisation spatiale de l'effet de l'ICU à Paris et ses alentours. En effet à partir de nos résultats statistiques , nous avons pu caractériser les environnements autour de nos stations météo. Le résultat logique que nous retrouvons dans nos résultats est que les surfaces importantes de bâti se trouve au endroit où les stations météo ont des valeurs de température élévée. A l'inverse les surfaces importantes de végétation se trouve au endroit où les stations météo ont des valeurs de température faible. Spatialement, nous pouvons voir le contraste entre l'agglomération parisienne et les alentours. Néanmoins certaines de nos stations météo sont localement différentes de celles aux alentours.
